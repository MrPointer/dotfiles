...
The sub-plan should say whether the feature should be mentioned as a primary concept, a small example, or only an implementation detail. Do not let a narrow feature become the center of a broad domain, architecture, or process doc unless the feature changes that document's central subject.
