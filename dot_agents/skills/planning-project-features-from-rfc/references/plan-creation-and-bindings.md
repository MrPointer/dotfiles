# Plan Creation And Bindings

Use this reference when creating plan files, assigning execution models, establishing runtime bindings, or writing lead-agent execution instructions.
...
Use [../assets/master-plan-template.md](../assets/master-plan-template.md) and [../assets/sub-plan-template.md](../assets/sub-plan-template.md).
...
When in doubt, use at least the mid-tier model. Document the recommendation in each sub-plan's `## Execution Model` field with a brief rationale.
